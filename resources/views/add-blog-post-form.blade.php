      ...
      <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{url('store-form')}}">
       @csrf
        ...
        <div class="form-group">
            ...
            <input type="lokasi_latitude" id="lokasi_latitude" name="lokasi_latitude" class="form-control" required="">
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">lokasi_longitude</label>
            <input type="lokasi_longitude" id="lokasi_longitude" name="lokasi_longitude" class="form-control" required="">
        </div>
        <div class="form-group">
