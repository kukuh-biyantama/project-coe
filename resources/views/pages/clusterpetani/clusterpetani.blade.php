...
<div class="container-fluid mt--7">
    <h2 class="text-center mb-4 mt-4 text-light">Form Data Cluster</h2>
    ...
    <div class="container mt-4">
        ...
        <form id="regForm" action="/clusterpetanijson" method="POST">
            @csrf
            {{-- <h2 class="text-center mb-4 mt-4 text-light">Data Cluscter</h2> --}}
            ...
            <div class="tab">
                ...
                <div class="field-input">
                    ...
                    <p><input type="number" id="usia" placeholder="Masukkan Usia Anda" oninput="this.className = ''" name="usia" min="1"></p>
                </div>
                <div class="field-input">
            ...
            <div class="tab">
                ...
                <div class="field-input">
                    ...
                    <p><input type="number" placeholder="Masukkan Angka" oninput="this.className = ''" name="tnmPermusim" min="1">
                    </p>
                </div>
            </div>
            ...
            <div class="tab">
                <div class="field-input">
                    ...
                    <p><input type="number" placeholder="Luas Lahan" name="inptLuaslahan" min="1"></p>
                    <div class="form-radio">
                        <div class="up">
                ...
                <div class="field-input">
                    ...
                    <p><input type="number" placeholder="Berapa Lama Menjadi Petani" name="lmmnjdPetani" min="1"></p>
                </div>
                <div class="field-input">
                    <label class="col-form-label">Durasi Tanam</label>
                    <p><input type="number" placeholder="Durasi Waktu Tanam" name="drsTanam" min="1"></p>
                    <div class="form-radio">
                        <div class="up">
            ...
            <div class="tab">
                <div class="field-input">
                    ...
                    <p><input type="number" placeholder="Berapa Jumlah Bibit Yang Anda Gunakan" name="jmlBibit" min="1"></p>
                    <div class="form-radio">
                        <div class="up">
                ...
                <div class="field-input">
                    ...
                    <p><input type="number" placeholder="Berapa Jumlah Pupuk Yang Anda Gunakan" name="jmlPupuk" min="1"></p>
                    <div class="form-radio">
                        <div class="up">
                ...
                <div class="field-input">
                    ...
                    <p><input type="number" placeholder="Berapa Rata-Rata Hasil Panen Anda" name="ratarataHasilpanen" min="1"></p>
                    <div class="form-radio">
                        <div class="up">
