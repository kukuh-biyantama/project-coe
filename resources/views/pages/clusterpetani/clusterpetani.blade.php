    ...
    <form id="regForm" action="/clusterpetanijson" method="POST">
        ...
        <div class="tab">
            <div class="field-input">
                ...
                <p><input type="text" id="nama" placeholder="Masukkan Nama Anda" oninput="this.className = ''"
                        name="nama"></p>
            </div>
            <div class="field-input">
                <label for="inputUsiapetani" class="col-form-label">Usia</label>
                <p><input type="number" id="usia" placeholder="Masukkan Usia Anda" oninput="this.className = ''"
                        name="usia"></p>
            </div>
            <div class="field-input">
        ...
        <div class="tab">
            ...
            <div class="field-input">
                ...
                <p><input type="number" placeholder="Masukkan Angka" oninput="this.className = ''" name="tnmPermusim">
                </p>
            </div>
        </div>
        ...
        <div class="tab">
            ...
            <div class="field-input">
                ...
                <div class="form-radio">
                    <div class="up">
                        <input class="inputan" type="radio" name="hridurasiTanam" id="durasiTanam_hari"
                            value="Hari">
                        <label>Hari</label>
                    </div>
                </div>
                <div class="form-radio">
                    <div class="down">
                        <input class="inputan" type="radio" name="hridurasiTanam" id="durasiTanam_bulan"
                            value="Bulan">
                        <label>Bulan</label>
                    </div>
                </div>
        ...
        <div class="tab">
            ...
            <div class="field-input">
                ...
                <div class="form-radio">
                    <div class="up">
                        <input class="inputan" type="radio" name="stnratarataPanen" id="panen_kilogram"
                            value="Kilogram">
                        <label>Kilogram</label>
                    </div>
                </div>
                <div class="form-radio">
                    <div class="down">
                        <input class="inputan" type="radio" name="stnratarataPanen" id="panen_kwintal"
                            value="Kwintal">
                        <label>Kwintal</label>
                    </div>
                </div>
