                ...
                <div class="card mt-3">
                    <div class="card-body">
                        <form action="/insertdatapestisida" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="tempatMembeliPestisida" class="form-label" style="font-weight: 600;">Tempat Membeli Pestisida</label>
                            ...
                            <div class="mb-3">
                                <label for="tglSemprotPestisida" class="form-label" style="font-weight: 600;">Tanggal Semprot Pestisida</label>
                            ...
                            <div class="mb-3">
                                <label for="pestisidaKeterangan" class="form-label" style="font-weight: 600;">Keterangan Kegiatan</label>
